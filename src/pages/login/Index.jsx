    ...
    >
      <div className="container mx-auto backdrop-blur flex flex-col items-center max-w-[400px] shadow-2xl border-white rounded-xl py-8 px-2 md:mr-40">
        ...
        <form
          ...
          className="space-y-1 w-full px-4 relative"
        >
          ...
          <span
            ...
            className="absolute top-32 right-7 text-gray-600 cursor-pointer"
          >
          ...
          <button
            type="submit"
            className="py-3 px-6 mt-6 w-full rounded-md text-white font-bold cursor-pointer bg-gradient-to-r from-[#204d74] to-[rgb(55, 55, 55)] hover:from-[#0c4568] active:scale-95 duration-575"
          >
            Login
          </button>
        </form>
